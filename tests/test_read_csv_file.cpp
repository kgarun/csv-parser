...
TEST_CASE("col_pos() Test", "[test_col_pos]") {
    int pos = get_col_pos(
        "/Users/arun-8593/CLionProjects/dummy/tests/data//real_data/2015_StateDepartment.csv",
        "Entity Type");
    REQUIRE(pos == 1);
}
...
TEST_CASE("Prevent Column Names From Being Overwritten", "[csv_col_names_overwrite]") {
    ...
    for (auto& format_in : formats) {
        ...
        CSVReader reader("/Users/arun-8593/CLionProjects/dummy/tests/data//fake_data/ints_comments.csv", format_in);
...
TEST_CASE("get_file_info() Test", "[test_file_info]") {
    CSVFileInfo info = get_file_info(
        "/Users/arun-8593/CLionProjects/dummy/tests/data//real_data/2009PowerStatus.txt");
...
TEST_CASE( "Test Read CSV with Header Row", "[read_csv_header]" ) {
    // Header on first row
    constexpr auto path = "/Users/arun-8593/CLionProjects/dummy/tests/data//real_data/2015_StateDepartment.csv";
...
TEST_CASE("Test read_row() CSVField - Power Status", "[read_row_csvf3]") {
    CSVReader reader("/Users/arun-8593/CLionProjects/dummy/tests/data//real_data/2009PowerStatus.txt");
    CSVRow row;
