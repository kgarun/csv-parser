...
TEST_CASE ("Basic CSVReader Iterator Test", "[read_ints_iter]") {
    ...
    std::vector<std::string> col_names = { "A", "B", "C", "D", "E", "F", "G", "H", "I", "J" };
    int i                              = 1;
...
//     CSVReader r1(GetAbsolutePath("tests/data/fake_data/ints.csv"),
//         r2(GetAbsolutePath("tests/data/real_data/2015_StateDepartment.csv");
//
//     // Find largest number
